...
+ (FluxCameraModel *) cameraModelForPlatform:(FluxDevicePlatform)devplatform
{
    ...
    switch (devplatform)
    {
        ...
        case fdp_iPadMini1:
        case fdp_iPadMini2:
            cm = [cm initWithPixelSize:0.0000014 andXPixels:1080.0 andYPixels:1920.0 andFocalLength:0.00412 andHdToRawScale:HD_TO_RAW];   // same as iPhone 5, 5c for now.  this may need to change
            break;
        case fdp_iPhone4s:
            cm = [cm initWithPixelSize:0.0000014 andXPixels:1080.0 andYPixels:1920.0 andFocalLength:0.00428 andHdToRawScale:HD_TO_RAW];
            break;
        case fdp_iPhone5s:
            cm = [cm initWithPixelSize:0.0000015 andXPixels:1080.0 andYPixels:1920.0 andFocalLength:0.00412 andHdToRawScale:HD_TO_RAW];
            break;
        case fdp_unknown:
        case fdp_simulator:
        case fdp_iPhone5:
        case fdp_iPhone5c:
        default:
            cm = [cm initWithPixelSize:0.0000014 andXPixels:1080.0 andYPixels:1920.0 andFocalLength:0.00412 andHdToRawScale:HD_TO_RAW];
            break;
    }
