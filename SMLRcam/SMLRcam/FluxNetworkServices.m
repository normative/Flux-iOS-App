...
//NSString* const FluxProductionServerURL = _AWSProductionServerURL;
NSString* const FluxProductionServerURL = _AWSTestServerURL;
//NSString* const FluxProductionServerURL = _DSDLocalTestServerURL;
