...
CREATE TABLE public.images(
	...
	CONSTRAINT images_key PRIMARY KEY (imageid)
);
-- ddl-end --
...
-- object: image_imageid_idx | type: INDEX --
CREATE UNIQUE INDEX image_imageid_idx ON public.images
	USING btree
	(
	  imageid ASC NULLS LAST
	);
-- ddl-end --
...
COMMENT ON CONSTRAINT images_key ON public.images IS 'primary key for images';
-- Appended SQL commands --
ALTER TABLE images CLUSTER ON "image_time_stamp_cluster_idx";	-- cluster the table on timestamp
ALTER SEQUENCE imageid_seq OWNED BY images.imageid;		-- drop the sequence if the column goes away
-- ddl-end --
...
-- object: users_userid_cluster_idx | type: INDEX --
CREATE UNIQUE INDEX users_userid_cluster_idx ON public.users
	USING btree
	(
	  userid ASC NULLS LAST
	);
COMMENT ON INDEX users_userid_cluster_idx IS 'clustering index on userID';
-- ddl-end --
...
COMMENT ON CONSTRAINT users_key ON public.users IS 'primary key for users';
-- Appended SQL commands --
ALTER TABLE users CLUSTER ON "users_userid_cluster_idx";
ALTER SEQUENCE userid_seq OWNED BY users.userid;		-- drop the sequence if the column goes away
-- ddl-end --
...
CREATE TABLE public.tags(
	...
	CONSTRAINT tag_key PRIMARY KEY (tagid)
);
-- ddl-end --
...
-- object: tags_tagid_idx | type: INDEX --
CREATE UNIQUE INDEX tags_tagid_idx ON public.tags
	USING btree
	(
...
COMMENT ON CONSTRAINT tag_key ON public.tags IS 'primary key for tags table';
-- Appended SQL commands --
ALTER TABLE tags CLUSTER ON "tags_tagtext_cluster_idx";
ALTER SEQUENCE tagid_seq OWNED BY tags.tagid;		-- drop the sequence if the column goes away
-- ddl-end --
...
CREATE TABLE public.categories(
	...
	CONSTRAINT categories_key PRIMARY KEY (categoryid)
);
-- ddl-end --

-- object: categories_categoryid_cluster_idx | type: INDEX --
CREATE UNIQUE INDEX categories_categoryid_cluster_idx ON public.categories
	USING btree
	(
	  categoryid ASC NULLS LAST
	);
COMMENT ON INDEX categories_categoryid_cluster_idx IS 'clustering index on categoryID';
-- ddl-end --


COMMENT ON TABLE public.categories IS 'contains category definitions';
COMMENT ON CONSTRAINT categories_key ON public.categories IS 'primary key for categories table';
-- Appended SQL commands --
ALTER TABLE categories CLUSTER ON "categories_categoryid_cluster_idx";
ALTER SEQUENCE catid_seq OWNED BY categories.categoryid;		-- drop the sequence if the column goes away
-- ddl-end --
...
CREATE TABLE public.cameras(
	...
	description varchar(256),
	nickname varchar(64),
	CONSTRAINT cameras_key PRIMARY KEY (cameraid)
);
-- ddl-end --

-- object: cameras_cameraid_idx | type: INDEX --
CREATE UNIQUE INDEX cameras_cameraid_idx ON public.cameras
	USING btree
	(
...
COMMENT ON CONSTRAINT cameras_key ON public.cameras IS 'primary key for camera table';
-- Appended SQL commands --
ALTER TABLE cameras CLUSTER ON "cameras_deviceid_cluster_idx";
ALTER SEQUENCE cameraid_seq OWNED BY cameras.cameraid;		-- drop the sequence if the column goes away
-- ddl-end --
...
CREATE TABLE public.friends(
	...
	CONSTRAINT pk_friends PRIMARY KEY (userid)
);
-- ddl-end --
...
COMMENT ON CONSTRAINT pk_friends ON public.friends IS 'primary key of friends';
-- Appended SQL commands --
...
CREATE TABLE public.image_tags(
	...
	CONSTRAINT pk_image_tags PRIMARY KEY (imageid,tagid)
);
-- ddl-end --

-- object: imagetags_imageid_idx | type: INDEX --
CREATE INDEX imagetags_imageid_idx ON public.image_tags
	USING btree
	(
	  imageid ASC NULLS LAST
	);
...
-- object: imagetags_tagid_cluster_idx | type: INDEX --
CREATE INDEX imagetags_tagid_cluster_idx ON public.image_tags
	USING btree
	(
	  tagid ASC NULLS LAST
	);
COMMENT ON INDEX imagetags_tagid_cluster_idx IS 'clustering index on tagID';
-- ddl-end --


COMMENT ON TABLE public.image_tags IS 'relates an image to its tag(s) ';
-- Appended SQL commands --
ALTER TABLE image_tags CLUSTER ON "imagetags_tagid_cluster_idx";
-- ddl-end --
